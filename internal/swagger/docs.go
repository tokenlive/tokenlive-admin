    ...
    "paths": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/schema.AuditLog"
                                            }
                                        }
                                    }
                                }
        ...
        "/api/v1/current/logout": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Request body (optional, for refresh token revocation)",
                        "name": "body",
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/schema.RefreshTokenForm"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/schema.ModelCatalogI18nForm"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/model-catalog-i18n/batch": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/schema.ModelCatalogI18nBatchForm"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/model-catalogs": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Status (available/paused)",
                        "name": "status",
                        "in": "query"
                    },
                    {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/schema.ModelCatalog"
                                            }
                                        }
                                    }
                                }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/schema.ModelCatalogForm"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/model-catalogs/slug/{slug}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/schema.ModelCatalogPublishForm"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/model-catalogs/{model_id}/prices": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/schema.ModelPriceVersion"
                                            }
                                        }
                                    }
                                }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/schema.ModelPriceVersionForm"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/model-price-versions/current": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/model-price-versions/{id}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/model-price-versions/{id}/deactivate": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/biz.PortalUserResult"
                                            }
                                        }
                                    }
                                }
        ...
        "/api/v1/ops/portal/workspaces/{workspace_id}/api-keys": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/biz.PortalWorkspaceAPIKey"
                                            }
                                        }
                                    }
                                }
        ...
        "/api/v1/policy/policy-circuit-breaks/{id}/enabled": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/schema.PolicyEnabledForm"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/policy/policy-invocations/{id}/enabled": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/policy/policy-limits/{id}/enabled": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/policy/policy-loadbalances/{id}/enabled": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/policy/policy-routes/{id}/enabled": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/policy/policy-taggings/{id}/enabled": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
    ...
    "definitions": {
        ...
        "schema.LoginForm": {
            ...
            "properties": {
                ...
                "remember_me": {
                    "description": "Remember login state (30 days)",
                    "type": "boolean"
                },
                "username": {
        ...
        "schema.LoginToken": {
            ...
            "properties": {
                ...
                "refresh_token": {
                    "description": "Refresh token (only when remember_me=true)",
                    "type": "string"
                },
                "token_type": {
        ...
        "schema.ModelCatalogForm": {
            ...
            "properties": {
                ...
                "model_code": {
                    "description": "Link to admin model",
                    "type": "string",
                    "maxLength": 64
                },
                "model_id": {
        ...
        "schema.ModelCatalogI18nBatchForm": {
            "type": "object",
            "required": [
                "entries",
                "model_id"
        ...
        "schema.ModelCatalogPublishForm": {
            ...
            "properties": {
                "published_at": {
                    "description": "Publish time (defaults to now)",
                    "type": "string"
                },
                "visibility": {
        ...
        "schema.PolicyLimitForm": {
            ...
            "properties": {
                ...
                "limit_by": {
                    "description": "Limit key dimensions (JSON)",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "schema.TaggingAction": {
            ...
            "properties": {
                ...
                "type": {
                    "description": "动作类型/操作范围，如 TAG, REQ_HEADER, RSP_HEADER 等",
                    "type": "string"
                },
                "value": {
