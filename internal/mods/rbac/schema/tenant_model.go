...
type TenantModel struct {
	...
	CreatedAt  time.Time `json:"created_at" gorm:"autoCreateTime;comment:Create time;"`
	UpdatedAt  time.Time `json:"updated_at" gorm:"autoUpdateTime;comment:Update time;"`
}
