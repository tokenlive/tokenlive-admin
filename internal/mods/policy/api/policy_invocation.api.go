...
// @Tags PolicyInvocationAPI
// @Security ApiKeyAuth
// @Summary Toggle policy invocation enabled status by ID
// @Param id path string true "unique id"
...
// @Failure 401 {object} util.ResponseResult
// @Failure 500 {object} util.ResponseResult
// @Router /api/v1/policy/policy-invocations/{id}/enabled [put]
func (a *PolicyInvocation) UpdateEnabled(c *gin.Context) {
	ctx := c.Request.Context()
	...
	err := a.PolicyInvocationBIZ.ToggleEnabled(ctx, c.Param("id"), item)
	if err != nil {
		util.ResError(c, err)
		return
	}
...
// @Failure 401 {object} util.ResponseResult
// @Failure 500 {object} util.ResponseResult
// @Router /api/v1/policy/policy-invocations/{id}/copy-to-model [post]
func (a *PolicyInvocation) CopyToModel(c *gin.Context) {
	ctx := c.Request.Context()
	...
	result, err := a.PolicyInvocationBIZ.CopyTemplateToModel(ctx, c.Param("id"), item)
	if err != nil {
		util.ResError(c, err)
		return
	}
