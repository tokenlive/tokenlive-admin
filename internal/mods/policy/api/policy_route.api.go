...
// @Tags PolicyRouteAPI
// @Security ApiKeyAuth
// @Summary Toggle policy route enabled status by ID
// @Param id path string true "unique id"
...
// @Failure 401 {object} util.ResponseResult
// @Failure 500 {object} util.ResponseResult
// @Router /api/v1/policy/policy-routes/{id}/enabled [put]
func (a *PolicyRoute) UpdateEnabled(c *gin.Context) {
	ctx := c.Request.Context()
	...
	err := a.PolicyRouteBIZ.ToggleEnabled(ctx, c.Param("id"), item)
	if err != nil {
		util.ResError(c, err)
		return
	}
...
// @Failure 401 {object} util.ResponseResult
// @Failure 500 {object} util.ResponseResult
// @Router /api/v1/policy/policy-routes/{id}/copy-to-model [post]
func (a *PolicyRoute) CopyToModel(c *gin.Context) {
	ctx := c.Request.Context()
	...
	result, err := a.PolicyRouteBIZ.CopyTemplateToModel(ctx, c.Param("id"), item)
	if err != nil {
		util.ResError(c, err)
		return
	}
