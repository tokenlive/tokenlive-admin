...
assert.equal(normalizePortalAPIKeys([{ expires_at: '0001-01-01T00:00:00Z', last_used_at: null }])[0].expires_at, '-')
assert.equal(normalizePortalAPIKeys([{ expires_at: '0001-01-01T00:00:00Z', last_used_at: null }])[0].last_used_at, '-')
assert.equal(portalAPIKeyStatusColor('enabled'), 'green')
